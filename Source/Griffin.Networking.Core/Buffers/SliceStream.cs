    ...
    public class SliceStream : Stream, IBufferStream, IPeekable
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (count + offset >= _slice.Count)
                throw new ArgumentOutOfRangeException("count", count, "offset + count must be less than slice size: " + _slice.Count);
        ...
        public int CopyTo(Stream other, int count)
        {
            if (other == null) throw new ArgumentNullException("other");
            if (count + Position > _slice.Count)
                throw new ArgumentOutOfRangeException("count", count, "Count+Position is larger than the allocated buffer size");
        ...
        /// </summary>
        public int RemainingLength { get { return (int)(Length - Position); } }
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            if (count + Position >= _slice.Count)
                throw new ArgumentOutOfRangeException("count", count, "Position + count must be less than " + _slice.Count);
            if (offset + count > buffer.Length)
                throw new ArgumentOutOfRangeException("offset", offset, "Offset + Count must be less than " + buffer.Length);
        ...
        public override long Position
        {
            ...
            {
                if (value > Length)
                    throw new ArgumentOutOfRangeException("value", value, "Position must be less than the written length which is " + Length);
                if (value < 0)
